...
interface StoreSwitcherProperties extends PopoverTriggerProperties {
  items: Record<string, any>[];
}

export default function StoreSwitcher({ className, items = [] }: StoreSwitcherProperties) {
  ...
  const currentStore = formattedItems.find((item) => item.value === parameters.storeId);
